      ...
      <div className="max-w-[1440px] mx-auto py-6 px-10 flex justify-between">
        ...
        <div className="hidden lg:flex">
          <nav className="flex items-center">
            ...
            <NavLink to="/agent" className={({ isActive }) => (isActive ? "text-purple-500 block p-3 text-lg navlink" : "block p-3 text-lg navlink")}>
              Agent
            </NavLink>
            <NavLink to="/contact" className={({ isActive }) => (isActive ? "text-purple-500 block p-3 text-lg navlink" : "block p-3 text-lg navlink")}>
              Contact
            </NavLink>
            <NavLink to="/blog" className={({ isActive }) => (isActive ? "text-purple-500 block p-3 text-lg navlink" : "block p-3 text-lg navlink")}>
              Blog
            </NavLink>
        ...
        {/* Hamburger menu */}
        <div onClick={handleNav} className="block lg:hidden mr-0 p-2 rounded-2xl hover:bg-purple-700 duration-300">
