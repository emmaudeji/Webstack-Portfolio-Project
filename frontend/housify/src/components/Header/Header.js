      ...
      <div className="max-w-[1440px] mx-auto py-6 px-10 flex justify-between">
        ...
        <div className="hidden md:flex">
          <nav className="flex items-center">
            <NavLink to="/" className={({ isActive }) => (isActive ? "text-purple-600 mr-6" : "mr-6 navlink")}>
              Home
            </NavLink>
            <NavLink to="/about" className={({ isActive }) => (isActive ? "text-purple-600 mr-6" : "mr-6 navlink")}>
              About
            </NavLink>
            <NavLink to="/property" className={({ isActive }) => (isActive ? "text-purple-600 mr-6" : "mr-6 navlink")}>
              Property
            </NavLink>
            <NavLink to="/agent" className={({ isActive }) => (isActive ? "text-purple-600 mr-6" : "mr-6 navlink")}>
              Agent
            </NavLink>
            <NavLink to="/contact" className={({ isActive }) => (isActive ? "text-purple-600 mr-6" : "mr-6 navlink")}>
              Contact
            </NavLink>
            <NavLink to="/blog" className={({ isActive }) => (isActive ? "text-purple-600 mr-6" : "mr-6 navlink")}>
              Blog
            </NavLink>
        ...
        <div className={nav ? "w-full left-0 flex justify-center text-center bg-zinc-900 top-[80px] absolute z-10" : "absolute left-[-100%]"}>
          <nav className="pb-8">
            <NavLink to="/" className={({ isActive }) => (isActive ? "text-purple-600 mr-6" : "block p-3 text-xl navlink")}>
              Home
            </NavLink>
